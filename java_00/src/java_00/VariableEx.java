...
//		
//		System.out.println("숫자변수 1 [" + varNum + "] 입니다.");
//		System.out.println("숫자변수 2 [" + varNumber + "] 입니다.");
//		
...
//		int var3 = 30;
//		
//		System.out.println("=== 3개 숫자 바꾸기 전 ===");
...
//		System.out.println("숫자 3 [ " + var3 + " ] ");
		...
		String year = "년도에 내 나이는 ";
		String year2 = "세 입니다.";
		
		int plusYear;
		
		for(plusYear=1; plusYear <20; plusYear++) {
			System.out.println((curYear + plusYear) + year + (curAge + plusYear) + year2);			
		}
		*/
	}
