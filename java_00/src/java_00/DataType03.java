...
public class DataType03 {
	 ...
	 */
		...
		System.out.println("두 숫자의 합은 ? " + intVal1 + intVal2);   //문자열 + 숫자 -> 문자열로 인식
...
//		strVal1 = (string)intStr1;
		...
		System.out.println("문자결합 :: " + intStr1 + intStr2);
		System.out.println("문자결합 :: " + strVal1 + strVal2);
		...
		System.out.println("strInt1 + int2 = " + strInt1 + strInt2);
		...
		System.out.println("strFloat1 : " + strFloat1);
		System.out.println("float2 : " + float2);
		System.out.println("strFloat1 + Float2 = " + (strFloat1 + float2));
