...
public class Method04 {
	...
	public static void main(String[] args) {
		...
		/*
		 * [ 요구사항 ] - 숫자를 2개 입력받아 연산식을 반환하는 메소드를 선언하세요. - 연산식 ( + , - , * , / , % )를 각각의
		 * 메소드로 선언하세요.
		 * 
		 * [조건 추가] - 0을 포함한 양수만 입력 가능 -------------------------- 1. 입력 > scanner 생성 2.
		 * 사용할 변수 선언 및 초기화 : int n1, int n2, String result 3. 메소드 선언 4. 매개변수 이용 메소드 작성
		 * 5. 값 반환 6. 반환값 출력
		 */
		...
		if ( n1 >= 0l && n2 >= 0 ) {
			...
			System.out.println("[ER] 0을 포함한 양수만 입력이 가능합니다.");
		}
